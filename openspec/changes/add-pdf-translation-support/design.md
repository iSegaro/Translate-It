...
The runtime architecture source of truth is `docs/technical/pdf-translator/PDF_TRANSLATION_ARCHITECTURE.md`. PDF is an independent feature with its own session model, dedicated viewer, logical block pipeline, and adaptive bilingual rendering.
