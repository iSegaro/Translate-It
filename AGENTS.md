...
- **Icon System**: Standardized monochrome UI icons via CSS Mask (`MaskIcon`) with `currentColor` theming, monochrome mask-compatible assets as single source of truth, and clear conventions for brand/multicolor `<img>` assets. See [docs/technical/ICON_SYSTEM.md](docs/technical/ICON_SYSTEM.md) and [docs/adr/ADR-001-svg-icon-system.md](docs/adr/ADR-001-svg-icon-system.md).
...
- [**ICON_SYSTEM.md**](docs/technical/ICON_SYSTEM.md): Monochrome icon standards, MaskIcon usage, monochrome asset conventions, and accessibility rules.
