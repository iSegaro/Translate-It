...
می‌توانید برای هر ارائه‌دهنده **چندین کلید API** وارد کنید (هر کلید در یک خط). افزونه موارد زیر را انجام می‌دهد:

- ✅ اگر کلید فعلی کار نکرد، به‌طور خودکار کلید بعدی را امتحان می‌کند
- ✅ کلیدها را به‌طور خودکار مرتب می‌کند (کلیدهای معتبر اول)
...
- **پشتیبانی از چندین کلید API**
  ...
  تمام ارائه‌دهندگان از وارد کردن چندین کلید API (هر کلید در یک خط در فیلد کلید API) پشتیبانی می‌کنند. از دکمه «تست کلیدها» برای اعتبارسنجی همه کلیدها و مرتب‌سازی خودکار آن‌ها (کلیدهای معتبر اول) استفاده کنید. افزونه به‌طور خودکار به کلید بعدی سوئیچ می‌کند اگر یکی از کلیدها به دلیل محدودیت quota یا اعتبار نامعتبر کار نکند.
...
برای توسعه فعال و اعمال تغییرات در لحظه، از دستورات زیر استفاده کنید:
...
این دستور lint (کد و استایل) و ساخت افزونه را انجام می‌دهد.
