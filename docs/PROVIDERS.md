...
برای پرووایدر جدید، توضیحات مربوطه را در فایل‌های زبان (`_locales/*/messages.json`) تعریف کنید و سپس در فایل `src/apps/options/tabs/LanguagesTab.vue` یک بلوک `v-else-if` برای نمایش آن توضیحات هنگام انتخاب پرووایدر اضافه نمایید.
