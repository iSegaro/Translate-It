...
- `RegionBenchmarkArtifact` defines versioned immutable artifact schema validation; `BenchmarkArtifactWriter` produces it from completed results without affecting execution or evaluation.
