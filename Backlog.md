...
- در پروژه چندین جای مختلف RTL Check نسبت به زبان وجود دارد. کدهای تکراری تولید شده. حالا که پروژه Language Detector قوی داره، بهتره که از همین استفاده بشه.
