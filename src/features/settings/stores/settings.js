...
function getDefaultSettings() {
  return {
    ...
    LIVE_CAPTION_ENABLED: CONFIG.LIVE_CAPTION_ENABLED ?? true,
    ...
    LIVE_CAPTION_STT_PROVIDER: CONFIG.LIVE_CAPTION_STT_PROVIDER || 'openai_whisper',
    LIVE_CAPTION_RETRY_LIMIT: CONFIG.LIVE_CAPTION_RETRY_LIMIT ?? 2,
