...
const getRawManifest = () => [
  ...
  },
  {
    ...
    features: ["translation", "text", "autoDetect"],
    needsApiKey: false,
    supported: true,
  },
  {
    ...
    features: ["translation", "text", "autoDetect", "formality"],
    needsApiKey: true,
  ...
  },
  {
    ...
    features: ["translation", "text", "context", "smart", "image", "dictionary"],
    needsApiKey: true,
  ...
  },
  {
    ...
    features: ["translation", "text", "context", "smart", "dictionary"],
    needsApiKey: true,
  ...
  },
  {
    ...
    features: ["translation", "text", "context", "smart", "thinking", "dictionary"],
    needsApiKey: true,
  ...
  },
  {
    ...
    features: ["translation", "text", "context", "configurable", "dictionary"],
    needsApiKey: true,
  ...
  // --- Group: LOCAL ---
  {
    ...
    features: ["translation", "text", "context", "offline", "dictionary"],
    needsApiKey: false,
  ...
  },
  {
    ...
    features: ["translation", "text", "autoDetect", "offline"],
    needsApiKey: false,
    supported: true,
  },
