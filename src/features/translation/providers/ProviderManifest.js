...
const getRawManifest = () => [
  // --- Group: FREE ---
  {
    ...
    features: ["translation", "text", "autoDetect", "bulk", "dictionary", "bilingual"],
    needsApiKey: false,
    supported: true,
  },
  {
    ...
    features: ["translation", "text", "autoDetect", "bulk", "bilingual"],
    needsApiKey: false,
    supported: true,
  },
  {
  ...
  // --- Group: AI ---
  {
    ...
    features: ["translation", "text", "context", "smart", "bulk", "image", "dictionary", "bilingual"],
    needsApiKey: true,
  ...
  },
  {
    ...
    features: ["translation", "text", "context", "smart", "image", "dictionary", "bulk", "bilingual"],
    needsApiKey: true,
  ...
  },
  {
    ...
    features: ["translation", "text", "context", "smart", "dictionary", "bulk", "bilingual"],
    needsApiKey: true,
  ...
  },
  {
    ...
    features: ["translation", "text", "context", "smart", "thinking", "dictionary", "bulk", "bilingual"],
    needsApiKey: true,
  ...
  // --- Group: LOCAL ---
  {
    ...
    features: ["translation", "text", "context", "offline", "dictionary", "bulk", "bilingual"],
    needsApiKey: false,
  ...
  },
  {
    ...
    features: ["translation", "text", "autoDetect", "offline", "bulk", "bilingual"],
    needsApiKey: false,
    supported: true,
  },
  {
  ...
  // --- Group: DEVELOPMENT ---
  {
    ...
    features: ["translation", "text", "context", "smart", "bulk", "streaming", "dictionary", "bilingual"],
    needsApiKey: false,
