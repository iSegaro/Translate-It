...
const getRawManifest = () => [
  // --- Group: FREE ---
  {
    ...
    features: ["translation", "text", "autoDetect", "bulk", "dictionary"],
    needsApiKey: false,
    supported: true,
  },
  {
    ...
    features: ["translation", "text", "autoDetect", "bulk"],
    needsApiKey: false,
    supported: true,
  },
  {
    ...
    features: ["translation", "text", "autoDetect", "formality", "bulk"],
    needsApiKey: true,
  ...
  // --- Group: AI ---
  {
    ...
    features: ["translation", "text", "context", "smart", "bulk", "image", "dictionary"],
    needsApiKey: true,
  ...
  },
  {
    ...
    features: ["translation", "text", "context", "smart", "image", "dictionary", "bulk"],
    needsApiKey: true,
  ...
  },
  {
    ...
    features: ["translation", "text", "context", "smart", "dictionary", "bulk"],
    needsApiKey: true,
  ...
  },
  {
    ...
    features: ["translation", "text", "context", "smart", "thinking", "dictionary", "bulk"],
    needsApiKey: true,
  ...
  },
  {
    ...
    features: ["translation", "text", "context", "configurable", "dictionary", "bulk"],
    needsApiKey: true,
  ...
  // --- Group: LOCAL ---
  {
    ...
    features: ["translation", "text", "context", "offline", "dictionary", "bulk"],
    needsApiKey: false,
  ...
  },
  {
    ...
    features: ["translation", "text", "autoDetect", "offline", "bulk"],
    needsApiKey: false,
    supported: true,
  },
  {
    ...
    features: ["translation", "dictionary", "autoLanguage"],
    needsApiKey: false,
    supported: true,
  },
  ...
  // --- Group: DEVELOPMENT ---
  {
    ...
    features: ["translation", "text", "context", "smart", "bulk", "streaming", "dictionary"],
    needsApiKey: false,
