...
export class FasterWhisperStreamingProvider extends BaseStreamingSTTProvider {
  ...
  _buildFinalTranscriptEvent(session, payload = {}) {
    ...
    return Object.freeze({
      ...
      sourceStartMs: Number.isFinite(Number(payload.startMs)) ? Number(payload.startMs) : null,
      sourceEndMs: Number.isFinite(Number(payload.endMs)) ? Number(payload.endMs) : null,
      sourceClockId: session.sessionId,
