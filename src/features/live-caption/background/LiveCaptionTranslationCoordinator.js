...
export class LiveCaptionTranslationCoordinator {
  ...
  _normalizeCommittedTranslatedCaptionSegment({ captionSegment, sourceSegment, tabId }) {
    ...
    return {
      ...
      projectedMediaStartMs: sourceSegment.projectedMediaStartMs ?? captionSegment.projectedMediaStartMs ?? null,
      projectedMediaEndMs: sourceSegment.projectedMediaEndMs ?? captionSegment.projectedMediaEndMs ?? null,
      timelineProjectionStatus: sourceSegment.timelineProjectionStatus ?? captionSegment.timelineProjectionStatus ?? null,
      timelineProjectionAnchorId: sourceSegment.timelineProjectionAnchorId ?? captionSegment.timelineProjectionAnchorId ?? null,
      timelineProjectionReason: sourceSegment.timelineProjectionReason ?? captionSegment.timelineProjectionReason ?? null,
