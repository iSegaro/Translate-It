...
export class UnifiedListenerManager {
  ...
  async handleMessage(message, sender, sendResponse) {
    console.debug('[UnifiedListenerManager] Message received, routing to CoreMessageRouter');
    ...
    try {
      ...
      // We just need to return what it returns
      ...
      console.error('[UnifiedListenerManager] Message routing error:', error);
      this.updateErrorMetrics('runtime.onMessage');
