...
export class CoreMessageRouter {
  ...
  async initialize() {
    ...
    // Setup runtime.onConnect listener for port connections
    browser.runtime.onConnect.addListener(this.handlePortConnection.bind(this));

    this.initialized = true;
    console.log('✅ CoreMessageRouter initialized');
  }
  ...
  registerHandler(action, handler, options = {}) {
    ...
    console.log(`✅ CoreMessageRouter: Registered handler for "${action}"`);
  }
  ...
  cleanup() {
    ...
    console.log('🧹 CoreMessageRouter cleaned up');
  }
}
