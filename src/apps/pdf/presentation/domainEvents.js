...
export const DomainEvents = Object.freeze({
  ...
  translationPartial: ({ occurrenceId, error } = {}) => ({ name: 'translation-partial', occurrenceId, error }),
  translationFailed: ({ occurrenceId, error } = {}) => ({ name: 'translation-failed', occurrenceId, error }),
