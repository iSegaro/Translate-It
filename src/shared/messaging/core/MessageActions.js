...
export class MessageActions {
  ...
  // Live Caption actions
  static LIVE_CAPTION_GET_TAB_ID = 'liveCaptionGetTabId';
  static LIVE_CAPTION_START_REQUEST = 'LIVE_CAPTION_START_REQUEST';
  static LIVE_CAPTION_PRIVACY_NOTICE = 'LIVE_CAPTION_PRIVACY_NOTICE';
  static LIVE_CAPTION_PRIVACY_ACCEPTED = 'LIVE_CAPTION_PRIVACY_ACCEPTED';
  static LIVE_CAPTION_START = 'LIVE_CAPTION_START';
  static LIVE_CAPTION_STOP = 'LIVE_CAPTION_STOP';
  static LIVE_CAPTION_AUDIO_CHUNK = 'LIVE_CAPTION_AUDIO_CHUNK';
  static LIVE_CAPTION_STT_RESULT = 'LIVE_CAPTION_STT_RESULT';
  static LIVE_CAPTION_TRANSLATE_REQUEST = 'LIVE_CAPTION_TRANSLATE_REQUEST';
  static LIVE_CAPTION_TRANSLATE_RESULT = 'LIVE_CAPTION_TRANSLATE_RESULT';
  static LIVE_CAPTION_VIDEO_CHANGED = 'LIVE_CAPTION_VIDEO_CHANGED';
  static LIVE_CAPTION_SEEK = 'LIVE_CAPTION_SEEK';
  static LIVE_CAPTION_STATUS = 'LIVE_CAPTION_STATUS';
  static LIVE_CAPTION_ERROR = 'LIVE_CAPTION_ERROR';
  static LIVE_CAPTION_CLEAR_CACHE = 'LIVE_CAPTION_CLEAR_CACHE';
  static LIVE_CAPTION_RUNTIME_START = 'LIVE_CAPTION_RUNTIME_START';
  static LIVE_CAPTION_RUNTIME_STOP = 'LIVE_CAPTION_RUNTIME_STOP';
  static LIVE_CAPTION_RUNTIME_STATUS = 'LIVE_CAPTION_RUNTIME_STATUS';
  static LIVE_CAPTION_RUNTIME_PAUSE = 'LIVE_CAPTION_RUNTIME_PAUSE';
  static LIVE_CAPTION_RUNTIME_RESUME = 'LIVE_CAPTION_RUNTIME_RESUME';
